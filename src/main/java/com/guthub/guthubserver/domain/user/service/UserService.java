...
public class UserService extends DefaultOAuth2UserService implements UserDetailsService {
    ...
    public Long addUser(UserRequestDTO dto) { // table id 리턴
        ...
        UserEntity entity = UserEntity.builder()
                ...
                .isLock(false)
                .isSocial(false)
                .roleType(UserRoleType.USER) // 일단 일반 유저로 가정
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return User.builder()  // static class
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (registrationId.equals(SocialProviderType.NAVER.name())) {
            ...
            Object naverEmail = attributes.get("email");
            email = naverEmail != null ? naverEmail.toString() : null;
            Object naverNickname = attributes.get("nickname");
            nickname = naverNickname != null ? naverNickname.toString() : username;
            ...
            email = googleEmail != null ? googleEmail.toString() : null;
            Object googleName = attributes.get("name");
            nickname = googleName != null ? googleName.toString() : username;
        } else {
